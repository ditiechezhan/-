...
var basicURL = 'http://t.yushu.im/v2/book/isbn/';
var app = getApp()
Page({
  /**
   * 页面的初始数据
  ...
  onLoad: function () {
    var that = this
      that.setData({
        ...
        ownerGender: app.globalData.userInfo.gender
      }),
          ...
          query.find({
            ...
            error: function (error) {
              ...
              wx.showToast({
                ...
                title: '暂时没有查询到图书信息，请在“我的”栏目反馈信息给客服人员',
  ...
  bindSubmit: function () {
    ...
    post.set("campus", this.data.campus);
